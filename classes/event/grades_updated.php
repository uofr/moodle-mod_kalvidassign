...
/**
 * Event class of Kaltura Video assignment.
 *
 * @package   mod_kalvidassign
 * @copyright (C) 2016-2017 Yamaguchi University <gh-cc@mlex.cc.yamaguchi-u.ac.jp>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class grades_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_grades_updated', 'kalvidassign');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' updated grades for the Kaltura video assignment with "
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'kalvidassign', 'updated grades of submissions',

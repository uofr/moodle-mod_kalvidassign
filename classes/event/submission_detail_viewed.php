...
class submission_detail_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_detail_viewed', 'kalvidassign');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' viewed the submission details of Kaltura media assignment with "
    ...
    public function get_url() {
        return new \moodle_url('/mod/kalvidassign/single_submission.php',
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'kalvidassign', 'viewed media submission details',

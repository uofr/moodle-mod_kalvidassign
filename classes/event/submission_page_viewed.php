...
/**
 * Event class of YU Kaltura Media assignment.
 *
 * @package   mod_kalvidassign
 * @copyright (C) 2016-2017 Yamaguchi University <gh-cc@mlex.cc.yamaguchi-u.ac.jp>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_page_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_page_viewed', 'kalvidassign');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' viewed the submission page of the Kaltura media assignment with "
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'kalvidassign', 'viewed the media submission page',
